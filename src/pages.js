...
export const pages = [
    {
        ...
        `,
        "btn-1":`<li><button id="choice-1" class="text-medium button-answer" value="3">Нужно попытаться найти дружелюбных князей, готовых помочь мальчику вернуть отчину. Уверен, такие найдутся!</button></li>`,
        "btn-2":`<li><button id="choice-2" class="text-medium button-answer" value="8">Необходимо обратиться за помощью к польскому королю, с которым у нас есть давние связи. Конечно, за свою помощь он попросит золото, серебро или часть земельных владений, но, вернув свои земли и заручившись верной дружиной, мы сможем легко вернуть все отданное обратно. Тем паче, что я знаю язык Ляхов. Я знал, что это мне не единожды пригодиться!</button></li>`,
    ...
    <li class="page">
        ...
        "btn-2":`<li><button id="choice-2" class="text-medium button-answer" value="10">Нужно согласиться на предложение короля. Однако, если он позволил себе такое, то чем мы хуже? Пусть в конце поединков он сам выйдет сразиться со мной на мечах!</button></li>`,
        "btn-3":`<li><button id="choice-3" class="text-medium button-answer" value="9">Я соглашусь биться на турнире с польскими рыцарями! Посмотрим, кто из нас сильнее!</button></li>`,
    ...
    },
    {
        ...
        `,
        "btn-1":`<li><button id="choice-1" class="text-medium button-answer" value="7">Надо вдвоем отбиваться от врагов! От моего трупа князю на чужбине будет мало проку. Победим заговорщиков, а дальше подумаем, что делать…</button></li>`,
        "btn-2":`<li><button id="choice-2" class="text-medium button-answer" value="6">Князь, беги! Попробую один отбиться от врагов, а потом найти князя в безопасных покоях замка.</button></li>`,
...

    {
        ...
        "btn-2":`<li><button id="choice-2" class="text-medium button-answer" value="10">Это предложение нам по душе! Пора молодому князю занять свое истинное место среди Рюриковичей! Седлайте коней! Мы разгромим эту горстку русских князей!</button></li>`,
    ...
    <li class="page">
        ...
        "btn-2":`<li><button id="choice-2" class="text-medium button-answer" value="7">Необходимо принять приглашение и проводить в последний путь этого достойного юношу.</button></li>`,
...
`,
    ...
    <li class="page">
        ...
        "btn-2":`<li><button id="choice-2" class="text-medium button-answer" value="10">Кто мы такие, чтобы отказывать великому православному правителю? Мы принимаем предложение. Я готов переговорить с аколуфом сейчас же!</button></li>`,
...
`,
    ...
    },
    {
        ...
        "btn-3":`<li><button id="choice-3" class="text-medium button-answer" value="10">Что ж… Чего можно было ждать от <a href="#" alt="Ссылка" data-tooltip="Половцы – классический 
                            кочевой скотоводческий народ, живший в регионе Дешт-и-Кипчак (Половецкая степь), 
                            вытеснивший в XI в. торков и печенегов. Половцы активно взаимодействовали с русскими княжествами 
                            через династические браки и участие в междоусобных войнах. Первым князем, который привел 
                            половцев войной на Русскую землю, был Олег Святославич (ум. 1115 г.), который в 1078 г. 
    ...
    },
    {
        ...
        "btn-2":`<li><button id="choice-2" class="text-medium button-answer" value="7">Что ж, если таково предложение <a href="#" alt="Ссылка" data-tooltip="Новгородская земля географически располагалась на севере Древней Руси. В годы наивысшего расцвета ее владения могли достигать Уральских гор на востоке и Балтийского моря – на западе. В период раздробленности Новгород постепенно освобождался от зависимости от Киева, однако в то же время, росло его соперничество с Владимиро-Суздальским княжеством. Именно в Новгороде найдено уже более 1100 берестяных грамот – уникальных памятников древнерусской письменности.">Новгорода</a>, мы согласны. Надеюсь, новгородский князь сдержит свое слово</button></li>`,
        "btn-3":``,
    ...
    },
    {
        ...
        `,
        "btn-1":`<li><button id="choice-1" class="text-medium button-answer" value="10">Нужно сражаться. Вперед, за мной, храброе воинство!</button></li>`,
    ...
    },
    {
        ...
        "btn-2":`<li><button id="choice-2" class="text-medium button-answer" value="20">Кажется, князь предлагал стать мне его покладником… Может, все же принять его предложение?..</button></li>`,
        "btn-3":``,
